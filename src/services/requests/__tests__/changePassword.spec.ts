...
const testChangePasswordData: ChangePassword = {
...
describe('Change Password', () => {
  ...
  it('Should throw an error', async () => {
    ...
    await expect(changePassword(httpClient, testChangePasswordData, token)).rejects.toThrow(
      mockError,
    );
  });
